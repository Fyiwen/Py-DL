...
class BRNN(nn.Module):
    def __init__(self,input_size,hidden_size,num_layers,num_classes):
        ...
        self.lstm=nn.LSTM(input_size,hidden_size,num_layers,batch_first=True,bidirectional=True)#self.lstm=nn.LSTM(input_size,hidden_size,num_layers,batch_first=True)
